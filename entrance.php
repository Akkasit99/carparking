...
require_once 'includes/entrance_data_handler.php';
...
$result = getEntranceData($selected_date, $selected_time, $supabase_url, $supabase_key);
?>
<!DOCTYPE html>
<html lang="th">
<head>
  ...
  <title>ข้อมูลรถทางเข้า - Car Parking System</title>
        ...
        <div class="header-left">
          <div class="header-brand">
            ...
            <div class="brand-text">
              <h1>ข้อมูลรถทางเข้า</h1>
              <span>Entrance Data Management</span>
            </div>
          </div>
        </div>
        ...
        <div class="filter-section">
          <form method="GET" action="" class="filter-form">
            ...
            <div class="filter-group">
              ...
              <button type="button" class="btn-secondary" onclick="resetFilter()">
                <i class="fas fa-undo"></i> ล้างฟิลเตอร์
              </button>
            </div>
          </form>
        </div>
        ...
        <div class="table-container">
          <table>
            ...
            <?php
              ...
              $imagesData = renderEntranceTable($result, $selected_date, $selected_time);
            ?>
          </table>
        </div>
      </div>
