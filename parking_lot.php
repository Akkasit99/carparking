...
require_once 'includes/parking_lot_data_handler.php';
...
$result = getParkingLotData($selected_date, $selected_time, $supabase_url, $supabase_key);
?>
<!DOCTYPE html>
<html lang="th">
<head>
    ...
    <div class="page-wrapper">
        ...
        <div class="table-container">
            <table>
                ...
                $imagesData = renderParkingLotTable($result, $selected_date, $selected_time);
                ?>
            </table>
                </div>
            </div>
